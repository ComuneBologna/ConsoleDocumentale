 ...
 */
@NoArgsConstructor
public class CollegaPraticaProcediResult implements Result {
	...
	public CollegaPraticaProcediResult(PraticaDTO praticaDTO) {
		super();
		this.praticaDTO = praticaDTO;
	}

	public CollegaPraticaProcediResult(String msgError) {
		super();
		this.error = true;
