...
import it.eng.portlet.consolepec.gwt.client.presenter.pec.WorklistPecInPresenter.AssegnaCommand;
...
import it.eng.portlet.consolepec.gwt.client.widget.formricerca.FormRicercaWorklistPecIn;
...
public class WorklistPecInView extends ViewImpl implements WorklistPecInPresenter.MyView {
	...
	FormRicercaWorklistPecIn formRicercaAttivo;
	...
	public interface Binder extends UiBinder<Widget, WorklistPecInView> {
	}
	...
	@Inject
	public WorklistPecInView(final Binder binder, final EventBus eventBus, ConfigurazioniHandler configurazioniHandler, ProfilazioneUtenteHandler profilazioneUtenteHandler) {
	...
	public void setFormRicerca(final AnagraficaWorklist worklistConfiguration, RicercaCommand ricercaCommand, GroupSuggestBoxProtocollazione groupSuggest) {
		...
		if(!formRicercaPerNomeWorklistMap.containsKey(worklistConfiguration.getNome())){
			FormRicercaBase formRicerca = new FormRicercaWorklistPecIn();
			...
			formRicercaAttivo = (FormRicercaWorklistPecIn) formRicerca;
			...
			CustomSuggestBox[] trs = groupSuggest.getSuggestBoxTitoloRubricaSezione(null);
			proto.configura(ricercaCommand, groupSuggest.getSuggestBoxTipologiaDocumento(), trs[0], trs[1], trs[2]);
	...
	public void impostaTitolo(String titolo) {
		titoloWorklist.setInnerText(titolo);
	}
