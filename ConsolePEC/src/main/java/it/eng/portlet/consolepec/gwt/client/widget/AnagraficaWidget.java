...
public class AnagraficaWidget extends Composite {
	...
	public AnagraficaWidget(String valoreDatoAggiuntivo, final Command selezionaAnagraficaCommand, boolean navigabile, DispatchAsync dispatch,
