...
import it.eng.portlet.consolepec.gwt.client.widget.formricerca.FormRicercaSceltaTemplate;
...
public class SceltaTemplateView extends ViewImpl implements SceltaTemplatePresenter.MyView {

	private final Widget widget;

	public interface Binder extends UiBinder<Widget, SceltaTemplateView> {
	}
	...
	@UiField(provided=true)
	FormRicercaSceltaTemplate formRicerca;
	...
	@Inject
	public SceltaTemplateView(final Binder binder, final EventBus eventBus, ConfigurazioniHandler configurazioniHandler) {
		...
		this.formRicerca = new FormRicercaSceltaTemplate(configurazioniHandler);
	...
	Set<String> idSelezionati = new HashSet<String>();
