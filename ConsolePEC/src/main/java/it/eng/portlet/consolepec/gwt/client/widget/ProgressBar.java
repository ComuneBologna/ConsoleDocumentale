...
/**
 * Widget che mostra l'avanzamento di un'operazione.<br>Necessita dei seguenti CSS:
 * 
 * <h3>CSS Style Rules</h3>
 * <ul class='css'>
 * <li>.engit-ProgressBar-shell { primary style }</li>
 * <li>.engit-ProgressBar-shell .engit-ProgressBar-bar { the actual progress bar }</li>
 * <li>.engit-ProgressBar-shell .engit-ProgressBar-text { text on the bar }</li>
 * <li>.engit-ProgressBar-shell .engit-ProgressBar-text-firstHalf { applied to text when progress is less than 50 percent }</li>
 * <li>.engit-ProgressBar-shell .engit-ProgressBar-text-secondHalf { applied to text when progress is greater than 50 percent }</li>
 * </ul>
 * 
 * P.S. Questa progressbar è "liberamente ispirata" all'omonima classe di gwt-incubator rispetto alla quale sono state rimosse le api deprecate.
 * 
 * @author fmattiazzo
 */
public class ProgressBar extends Widget {
	...
	public ProgressBar(double minProgress, double maxProgress, double curProgress, TextFormatter textFormatter) {
		...
		textElement.setPropertyString("className", "engit-ProgressBar-text-firstHalf");
	...
	public void setProgress(double curProgress) {
		...
		textElement.setPropertyString("className", (percent < 50) ? "engit-ProgressBar-text engit-ProgressBar-text-firstHalf" : "engit-ProgressBar-text engit-ProgressBar-text-secondHalf" );
		// Realign the text
		redraw();
	}
