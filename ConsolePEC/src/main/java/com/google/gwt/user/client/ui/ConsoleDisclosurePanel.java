...
public class ConsoleDisclosurePanel extends Composite implements
FiresConsoleDisclosureEvents, HasWidgets.ForIsWidget, HasAnimation,
    HasOpenHandlers<ConsoleDisclosurePanel>, HasCloseHandlers<ConsoleDisclosurePanel> {
  ...
  private static class ContentAnimation extends Animation {
    ...
    /**
     * The {@link ConsoleDisclosurePanel} being affected.
     */
    private ConsoleDisclosurePanel curPanel;
     ...
     */
    public void setOpen(ConsoleDisclosurePanel panel, boolean animate) {
    ...
    protected void onComplete() {
      ...
      curPanel.contentWrapper.getElement().getStyle().clearProperty("overflow");
      curPanel = null;
    }
    ...
    protected void onStart() {
      ...
      curPanel.contentWrapper.getElement().getStyle().setProperty("overflow", "hidden");
    }
  ...
  /**
   * The default header widget used within a {@link ConsoleDisclosurePanel}.
   */
  private class DefaultHeader extends Widget implements HasText,
      OpenHandler<ConsoleDisclosurePanel>, CloseHandler<ConsoleDisclosurePanel> {
    ...
    public final void onClose(CloseEvent<ConsoleDisclosurePanel> event) {
      setStyle();
    }

    public final void onOpen(OpenEvent<ConsoleDisclosurePanel> event) {
      setStyle();
    }
   ...
   */
  @Deprecated
  public ConsoleDisclosurePanel(DisclosurePanelImages images, String headerText,
      boolean isOpen) {
    this();
    setOpen(isOpen);
   ...
   * @param headerText the text to be displayed in the header
   */
  public ConsoleDisclosurePanel(ImageResource openImage, ImageResource closedImage,
      String headerText) {
    this();
   ...
   * @param headerText the text to be displayed in the header
   */
  public ConsoleDisclosurePanel(String headerText) {
   ...
   */
  @Deprecated
  public ConsoleDisclosurePanel(String headerText, boolean isOpen) {
    this(DEFAULT_IMAGES.disclosurePanelOpen(),
        DEFAULT_IMAGES.disclosurePanelClosed(), headerText);
    this.setOpen(isOpen);
  }
   ...
   */
  @Deprecated
  public ConsoleDisclosurePanel(Widget header) {
    this();
    setHeader(header);
  }
   ...
   */
  @Deprecated
  public ConsoleDisclosurePanel(Widget header, boolean isOpen) {
    this();
    setHeader(header);
    setOpen(isOpen);
  }
  ...
  public HandlerRegistration addCloseHandler(
      CloseHandler<ConsoleDisclosurePanel> handler) {
   ...
   * @deprecated Use {@link ConsoleDisclosurePanel#addOpenHandler(OpenHandler)} and
   *             {@link ConsoleDisclosurePanel#addCloseHandler(CloseHandler)} instead
   */
  @Deprecated
  public void addEventHandler(final ConsoleDisclosureHandler handler) {
    ConsoleWrappedOldDisclosureHandler.add(this, handler);
  }
  ...
  public HandlerRegistration addOpenHandler(OpenHandler<ConsoleDisclosurePanel> handler) {
   ...
   */
  @Deprecated
  public void removeEventHandler(ConsoleDisclosureHandler handler) {
    ConsoleWrappedOldDisclosureHandler.remove(this, handler);
  }
